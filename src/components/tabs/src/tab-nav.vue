  ...
  export default {
    ...
    render(h) {
      ...
      const scrollBtn = scrollable
        ? [
          <span class={['neo-tabs__nav-prev', scrollable.prev ? '' : 'is-disabled']} on-click={scrollPrev}><i class="neo-icon-arrow-left">&#xe6a3;</i></span>,
          <span class={['neo-tabs__nav-next', scrollable.next ? '' : 'is-disabled']} on-click={scrollNext}><i class="neo-icon-arrow-right">&#xe6a2;</i></span>
        ] : null;
      ...
      const tabs = this._l(panes, (pane, index) => {
        ...
        const btnClose = closable
          ? <i class="neo-icon-close" on-click={(ev) => { onTabRemove(pane, ev); }}>&#xe6a6;</i>
          : null;
      ...
      return (
        <div class={['neo-tabs__nav-wrap', scrollable ? 'is-scrollable' : '']}>
          {scrollBtn}
          <div class={['neo-tabs__nav-scroll']} ref="navScroll">
            <div
